...
## Core Principle
**Minimize modifications to Cline original files using CARETI MODIFICATION comments**

## Pre-Modification Checklist
- [ ] Is this a Cline original file? (src/, webview-ui/, proto/, scripts/, evals/, docs/, locales/, configs/)
- [ ] Can this be done in careti-src/ instead? (Always prefer Level 1)
...
1. **First try**: Use careti-src/ wrapper (Level 1)
2. **Second try**: Minimal modification with CARETI comment (Level 2)
3. **Last resort**: Major modification with full documentation (Level 3)
</detailed_sequence_of_steps>

<general_guidelines>
This protocol ensures safe modification of Cline files while maintaining the ability to merge upstream changes. The CARETI MODIFICATION comment approach replaces the deprecated .cline backup method.
</general_guidelines>
