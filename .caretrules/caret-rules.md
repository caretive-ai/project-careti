...
- **AI reads**: `.caretrules/careti-rules.json` (English JSON, core principles only)
...
- **Sync method**: Keep `.caretrules` as the Single Source of Truth; update `careti-docs/development/` as the KO-first developer counterpart
...
### File Mapping
```
.caretrules/careti-rules.json              ↔ careti-docs/development/careti-rules.ko.md (KO counterpart)
.caretrules/workflows/*.md                ↔ careti-docs/development/index.md (KO dashboard links out to matching guides)
.caretrules/workflows/atoms/*.md|*.yaml    ↔ careti-docs/development/* (referenced where needed)
.caretrules/workflows/ai-work-protocol.md ↔ careti-docs/development/ai-work-protocol.md
.caretrules/workflows/ai-work-index*      ↔ careti-docs/development/ai-work-index.md
```
...
- **Rules/Workflows (SoT)**: `.caretrules/careti-rules.json`, `.caretrules/workflows/*`
...
- SoT index: `.caretrules/careti-rules.json`
