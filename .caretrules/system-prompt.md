...
│   ├── common_rules.json             # .caretrules principles
...
2. **Use references**: Link to `.caretrules` instead of repeating
3. **JIT loading**: Load detailed sections only when needed
4. **Compress examples**: Use concise code examples

## Related Documents
- `.caretrules/careti-architecture-guide.md`: Overall architecture
- `.caretrules/prompt-management.md`: Prompt management workflow
