...
- **Cline v3.26.6 병합**: 최신 Cline 업스트림(`v3.26.6`, 커밋 `82be7c4ed`)을 병합했습니다 (병합 커밋 `f8bd960b4`). 자세한 내용은 [CHANGELOG.md](CHANGELOG.md)를 참조하세요.
  - **주요 사용자 기능 업데이트**:
...
v3.17.13 이전 변경 사항은 [CHANGELOG.md](CHANGELOG.md)를 참조하세요.
