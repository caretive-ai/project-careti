...
- **[Logging Guide](./development/logging.mdx)**: Usage of CaretLogger, CaretWebviewLogger
...
> **_For: Developers and AI who want to understand specific feature implementation methods and architecture_**

- **[Persona System](./features/persona-system.mdx)**: Complete implementation guide for AI character persona system ✨ **Latest Completed**
...
> 
> 📋 **No tasks currently in progress.** New tasks will be created in the `tasks/` folder.
> 
> 🗂️ **Completed Tasks**: Historical work records can be found in the `tasks/completed/` folder.
...
- **Architecture**: `development/caret-architecture-and-implementation-guide.mdx` - Includes Hybrid Pattern v3.1 ✨
- **Patterns**: `development/frontend-backend-interaction-patterns.mdx`
- **Persona Implementation**: `features/persona-system.mdx` - Real implementation examples and technical details
