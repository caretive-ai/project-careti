...
자세한 아키텍처 정보는 [Caret 아키텍처 가이드](./caret-architecture-and-implementation-guide.md)를 참조하세요.
...
자세한 패턴은 [Frontend-Backend 상호작용 가이드](./frontend-backend-interaction-patterns.md)를 참조하세요.
...
1. **해당 기능 문서 업데이트**: `caret-docs/features/[feature-name].md`
...
자세한 테스트 전략, 테스트 작성 방법, 다양한 테스트 명령어 옵션 등은 **[Caret 테스트 가이드](./testing-guide.md)** 문서를 반드시 참조하세요. 이 가이드가 테스트에 관한 가장 상세하고 정확한 정보를 제공합니다.
...
자세한 내용은 [테스트 가이드](./testing-guide.md)의 커버리지 섹션을 참조하세요.
...
모든 문서는 [문서 작성 가이드](./documentation-guide.md)를 따라 작성해주세요.
...
자세한 로깅 가이드는 [로깅 가이드](./logging.md)를 참조하세요.
...
자세한 머징 가이드는 [업스트림 머징 가이드](../guides/upstream-merging.md)를 참조하세요.

## 📚 추가 리소스

### 핵심 문서들

- [아키텍처 가이드](./caret-architecture-and-implementation-guide.md) - 전체 시스템 구조
- [테스트 가이드](./testing-guide.md) - 테스트 작성 및 실행
- [로깅 가이드](./logging.md) - 로깅 시스템 사용법
- [문서화 가이드](./documentation-guide.md) - 문서 작성 표준
- [UI-Storage 플로우 가이드](./ui-to-storage-flow.md) - 데이터 흐름 이해
...
- [유틸리티 가이드](./utilities.md) - 개발 유틸리티 사용법
- [웹뷰 통신 가이드](./webview-extension-communication.md) - 프론트엔드-백엔드 통신
