# Caret Project New Developer Onboarding Guide 🚀

Welcome to the Caret project, new fellow developer! 🎉
We hope this guide helps you quickly adapt to the project and enjoy contributing, alongside your AI assistant! ｡•ᴗ•｡

## 1. Getting Started with Caret: A 3-Step Quick Journey 🗺️
...
1.  **📜 Project Constitution (`caretrules.ko.md`):**
...
2.  **🏗️ Project Blueprint (`caret-architecture-and-implementation-guide.mdx`):**
...
3.  **✅ Quality Assurance Certificate (`testing-guide.mdx`):**
...
## 2. Work Cycle: Tasks and Daily Logs 🗓️✅
...
## 3. Collaborating with Your AI Assistant: In-Depth Guide 💡
...
```json
// Bad Example 👎: The problematic initial thought_process
"thought_process": [
...
```json
// Good Example 👍: Improved thought_process
"thought_process": [
...
**Key Conclusion: Protocol always takes precedence over persona.** If the AI says, "I'll write tests first," it's not ignoring its persona, but faithfully following the project protocol to prevent larger problems. Please trust and proceed together. 😊
...
- **Bad Example 👎:** `"Help without pressure"`
- **Good Example 👍:** As in the improved `thought_process` above, behavioral guidelines should be clear so that the AI has no room for arbitrary interpretation.

**2. Persona defines 'how' to speak, protocol defines 'what' to do.**

- Persona rules should determine the AI's tone, attitude, etc. – the **style of communication**. In contrast, task procedures like writing tests and backing up files should be handled by project protocols like `.caretrules`.
...
Effective persona setup is the first step to making AI more than just a tool, but a true partner that understands the project's philosophy and grows with it. 🌿

## 4. Useful Commands and Tools 🛠️
