...
- **`development/caret-architecture-and-implementation-guide.md`** - 통합 아키텍처 가이드
...
### **caret-architecture-and-implementation-guide.md** → **다른 개발 문서들**
**관계**: 마스터 → 세부 가이드
...
2. `caret-architecture-and-implementation-guide.md` (섹션 10-11)
...
2. **아키텍처 패턴 변경** (caret-architecture-and-implementation-guide.md)
   → 세부 구현 가이드 업데이트
   → 작업 문서 템플릿 반영
