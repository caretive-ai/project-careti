...
**리뷰 일자:** 2025-11-21  
**원칙:** cline 베이스 + Caret 침습 (입력히스토리/i18n/브랜딩/페르소나 유지)
...
### Step 2: ChatTextArea.tsx 병합 (cline 기능 + Caret 침습)
...
- [ ] Caret 기능 유지: `useInputHistory`, i18n `t()`, Chatbot/Agent 라벨, 브랜드/모델 선택 UI
...
- [ ] Caret 기능 회귀 테스트(입력 히스토리, i18n, 모델 선택)
