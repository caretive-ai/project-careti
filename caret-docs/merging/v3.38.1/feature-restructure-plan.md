...
## 목표
- `caret-docs/features` 디렉토리의 파일 번호 체계 재정비
...
- `f04-caret-account.md` -> `f05-caret-account.md`
- `f05-rule-priority-system.md` -> `f06-rule-priority-system.md`
- `f06-caret-prompt-system.md` -> `f07-caret-prompt-system.md`
...
- `index.md` 업데이트
- `caret-docs` 내 모든 문서에서 이전 파일명 참조를 새 파일명으로 변경
...
- `caret-docs/merging/v3.38.1/attempt-2-master.md`: 작업 로그 추가
