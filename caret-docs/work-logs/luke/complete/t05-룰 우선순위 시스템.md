...
파일 시스템 정의:
src/core/storage/
├── disk.ts                        # .agents/context 파일명 정의 (CARET MODIFICATION)
...
```typescript
// CARET MODIFICATION: Implement rule priority system (.agents/context)
...
```typescript
// CARET MODIFICATION: Rule priority system (.agents/context)
