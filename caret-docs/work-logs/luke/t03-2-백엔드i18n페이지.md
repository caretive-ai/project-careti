...
### 2.1. 📋 i18n 시스템 자동 브랜드 전환 구현
- 백엔드 메시지 i18n 노출 옵션 시스템
- 웰컴페이지 및 각종 페이지 이식  
- **새 방향**: i18n 시스템도 브랜드 전환 스크립트로 자동화 (수동 머징 없음)
...
## 📋 2단계 세부 구현 계획 - 바로 작업 가능한 서브태스크

### 🔧 작업 1: i18n 자동 브랜드 전환 시스템 구현

#### **목표**: i18n 적용 파일들의 하드코딩 텍스트를 브랜드 전환 스크립트로 자동 변환
...
- 🔄 **i18n 자동 전환 필요**: 하드코딩 텍스트 브랜드 변환 자동화
- 🔄 **통합 테스트 필요**: i18n + 백엔드 메시지 + 브랜딩 통합 동작 확인
