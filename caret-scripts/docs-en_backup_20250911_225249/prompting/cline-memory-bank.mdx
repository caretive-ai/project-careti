...
3. **Paste into Cline** - Add as custom instructions or in a .agents/context file
...
#### Should I use custom instructions or .agents/context?
...
-   **.agents/context file**: Project-specific and stored in your repository. Good for per-project customization.
...
#### For .agents/context (Project-Specific)

1. Create a `.agents/context` file in your project root
