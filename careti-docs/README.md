...
안녕하세요! Careti 프로젝트의 공식 문서 허브에 오신 것을 환영합니다.
이곳에서는 Careti의 아키텍처, 개발 가이드, 온보딩 절차 등 모든 핵심 문서를 찾아보실 수 있습니다.
...
- **[아키텍처 및 구현 가이드](./development/careti-architecture-and-implementation-guide.md)**: Careti-Cline 통합 아키텍처 전체 가이드
...
### 📂 `user-guide/` (사용자 가이드)
> **_대상: Careti을 사용하는 최종 사용자_**

- **[Careti이란?](./user-guide/what-is-careti.md)**
- **[Careti 설치하기](./user-guide/installing-careti.md)**
- **[Careti 기능 소개](./user-guide/careti-features.md)**
...
### **AI 어시스턴트를 위한 문서**
- **핵심 룰**: `development/careti-rules.ko.md` - 프로젝트 전체 원칙과 규칙 (`.agents/context/careti-rules.json` SoT)
- **작업 방법**: `guides/ai-work-method-guide.md` - 강화된 체크포인트 포함
- **아키텍처**: `development/careti-architecture-and-implementation-guide.md` - 하이브리드 패턴 v3.1 포함 ✨
...
- **아키텍처 이해**: `development/careti-architecture-and-implementation-guide.md`
