...
| --- | --- | --- | --- | --- |
| TypeScript/Node | `npm run protos` | `careti-scripts/build/build-proto.mjs` | `src/shared/proto/**`, `src/generated/**`, `webview-ui/src/services/**` 등 | Generated 파일을 직접 수정하지 말 것 |
...
3.  **출력 확인**:
    ...
    find careti-src -name "*.js"  # 비어 있어야 함
    ```
...
- **문제 분석**: `careti-docs/work-logs/alpha/2025-10-16-js-file-generation-issue.md`
- **개선 계획**: `careti-docs/work-logs/alpha/2025-10-16-build-script-improvements.md`
- **빌드/테스트 요약**: `careti-docs/development/build-and-test.md`
