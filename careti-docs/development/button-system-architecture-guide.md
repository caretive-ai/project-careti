# Careti 버튼 시스템 아키텍처 가이드

Careti의 완전한 버튼 시스템 구조와 용어 정리 문서입니다. PRD 자동생성 등 새로운 기능 개발 시 UI 상호작용을 이해하는 데 필수적입니다.

## 🎯 **전체 버튼 시스템 구조**

Careti의 버튼 시스템은 두 가지 주요 영역으로 구분됩니다:
...
- `careti-src/core/messaging/__tests__/`
...
**이 문서는 Careti의 완전한 버튼 시스템을 설명합니다. PRD 자동생성 기능 개발 시 이 패턴들을 참조하여 일관된 사용자 경험을 구현할 수 있습니다.**
