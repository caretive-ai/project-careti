...
Careti 개발자가 확인해야 할 KO 우선 문서 모음입니다. `features.en`만 EN 병행을 유지하며, `.agents/context` 워크플로우와의 매핑을 함께 표기합니다.
...
- **[CLI 인증 플로우(서버 요구사항/목업)](./careti-cli-auth-flow.md)** — 서버팀 공유용, 목업으로 E2E 검증

## 🧭 개발 워크플로우 ('.agents/context/workflows' 매핑)
- **[Careti 개발 흐름](./careti-development.md)** ↔ `.agents/context/workflows/careti-development.md`
...
## 🏛️ 아키텍처 & 패턴 (참고용)
- **[Careti 아키텍처 개요](./careti-architecture-and-implementation-guide.md)** — merge-strategy/merge-workflow 참조
