...
Careti 개발을 위한 3단계 수정 전략을 따르고 있습니다.
...
```typescript
// 예시: careti-src/services/persona-service.ts
...
export function activate(context: vscode.ExtensionContext) {
  // CARETI MODIFICATION: Careti wrapper 초기화
...
<general_guidelines>
이 프레임워크는 Careti 확장을 가능하게 하면서 Cline의 무결성을 보존합니다.
