...
## 검증 방법론 (Careti JSON System Prompt 분석 기반)
...
3. 주석 추가: // CARETI MODIFICATION: [설명]
4. 변경 제한: 최대 1-3줄
...
3. modification_rules.comment 적용: // CARETI MODIFICATION: [설명]  
...
### 5단계: 의미적 동등성 점수 계산
**Careti JSON System Prompt 방법론 기반:**
...
## 참조 구현
입증된 방법론 기반:
`careti-main/careti-docs/reports/json-careti/semantic-equivalence-report.md`
...
예시:
```bash
node careti-scripts/utils/semantic-equivalence-checker.js .agents/context/workflows/backup-protocol.md careti-docs/experiments/backup-protocol-json.json
```
