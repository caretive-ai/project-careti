...
- **Controllers**: `src/core/controller/file/refreshRules.ts` plus `careti-src/core/controller/file/toggleCaretRule.ts`.
...
- Mark edits with `// CARETI MODIFICATION`; keep Cline backups where applicable. 
