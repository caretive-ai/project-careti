...
- ✅ **Careti 핵심 기능 보존**: .caretrules 우선순위, 페르소나 시스템, mode_system 설정
...
node slexn-codecenter/tools/brand-converter.js careti forward  # careti → cline
...
node slexn-codecenter/tools/brand-converter.js careti backward  # cline → careti
```
...
```bash
# 브랜딩 복원
node slexn-codecenter/tools/brand-converter.js careti backward  # 즉시 Careti 복원
...
#### **기능적 요구사항**
- ✅ **핵심 Careti 기능 보존**: .caretrules 우선순위, 페르소나, 브랜딩
