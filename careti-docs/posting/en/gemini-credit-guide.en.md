# How to Use Google Gemini for Free with Careti

Careti allows you to use a Google Gemini API key and receive up to 400,000 KRW in free credits, making it possible to use Gemini at no cost. Here’s how:
...
- **Generate and copy the API Key**:
    ...
    - This key will later be used in Careti’s Gemini API settings.

## 3. Set Up Google API Key in Careti
- **Select API Provider**: Choose Google Gemini as the API provider in Careti.
