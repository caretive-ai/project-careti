# CaretiでGoogle Geminiを無料で使用する方法

Caretiを使用すると、Google Gemini APIキーを使用して最大40万ウォンの無料クレジットを受け取ることができ、Geminiを無料で利用できます。方法は次のとおりです。
...
- **APIキーの生成とコピー**:
    ...
    - このキーは後でCaretiのGemini API設定で使用されます。

## 3. CaretiでGoogle APIキーを設定する
- **APIプロバイダーの選択**: CaretiのAPIプロバイダーとしてGoogle Geminiを選択します。
