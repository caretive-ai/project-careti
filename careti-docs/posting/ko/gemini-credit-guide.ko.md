# Careti과 함께 Google Gemini 무료로 사용하는 방법

Careti을 사용하면 Google Gemini API 키를 사용하여 최대 40만 원의 무료 크레딧을 받아 Gemini를 무료로 사용할 수 있습니다. 방법은 다음과 같습니다.
...
- **API 키 생성 및 복사**:
    ...
    - 이 키는 나중에 Careti의 Gemini API 설정에 사용됩니다.

## 3. 캐러티에 구글 API 키 설정하기
- **API 제공자 선택**: 캐러티의 API 공급자에 Google Gemini를 선택합니다.
