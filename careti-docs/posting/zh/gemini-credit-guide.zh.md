# 如何通过 Careti 免费使用 Google Gemini

Careti 允许您使用 Google Gemini API 密钥并获得高达 40 万韩元的免费积分，从而免费使用 Gemini。方法如下：
...
- **生成并复制 API 密钥**:
    ...
    - 此密钥稍后将用于 Careti 的 Gemini API 设置。

## 3. 在 Careti 中设置 Google API 密钥
- **选择 API 提供商**: 在 Careti 的 API 提供商中选择 Google Gemini。
