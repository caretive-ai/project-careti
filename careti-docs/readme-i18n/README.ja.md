...
> [v0.4.8 アップデート] **メッセージキューシステム / ESC即キャンセル / CLIエージェントモード / 無限ローディング修正**
  ...
  <p>
    ...
    &nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="https://docs.careti.ai/ja/getting-started/what-is-careti">
...
**Caretiモード**: ペルソナ、ローカライズ、最適化プロンプト
...
Clineで対応していないモデルをCaretiで使用できます。
...
- [アーキテクチャ](../development/careti-architecture-and-implementation-guide.md)
