...
### Memory Bank + .agents/context
For non-trivial projects. The Memory Bank captures project knowledge as Markdown in your repo. `.agents/context` are version-controlled instructions that align Cline's behavior with your team. [Learn more about Memory Bank](/prompting/cline-memory-bank) and [Cline Rules](/features/cline-rules).
...
3. **Team Projects**
    - Share common context files (consider using [.agents/context](/features/cline-rules) files in project roots)
