...
# Excludes what-is-careti.mdx files to preserve fork attribution
# Usage: ./cline-to-careti-content-replacer.sh [directory]
...
echo "ℹ️  Note: what-is-careti.mdx files were excluded to preserve fork attribution"