/**
 * Cross-validation tests for cline-latest vs Careti JSON components
...
describe("Prompt Generation Verification", () => {
	test("Generate and compare Careti and cline prompts", async () => {
		// --- Careti Prompt Generation ---
