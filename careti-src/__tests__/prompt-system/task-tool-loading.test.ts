...
import { CaretiJsonAdapter } from "@careti/core/prompts/system/adapters/CaretiJsonAdapter"
 ...
 */
describe("CaretiJsonAdapter - Claude Code Task Tool Loading", () => {
	let adapter: CaretiJsonAdapter

	beforeEach(() => {
		adapter = new CaretiJsonAdapter()
	})
