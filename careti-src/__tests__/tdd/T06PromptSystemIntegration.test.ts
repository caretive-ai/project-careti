	...
	describe("ClineLatestAdapter", () => {
		it("should generate a prompt containing core Cline concepts like ACT MODE", async () => {
			...
			const context = {
				...
				mode: CARETI_MODES.AGENT, // Even if mode is agent, cline adapter should produce its own prompt
				providerInfo: {
