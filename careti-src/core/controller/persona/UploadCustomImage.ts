// CARETI MODIFICATION: Handler for uploading custom persona images

import { PersonaStorage } from "@careti/services/persona/persona-storage"
import type { Controller } from "@core/controller"
import { UploadCustomImageRequest } from "@shared/proto/careti/persona"
...
export async function UploadCustomImage(controller: Controller, request: UploadCustomImageRequest): Promise<Empty> {
	try {
		...
		// CARETI MODIFICATION: Also save to file system for persistence
