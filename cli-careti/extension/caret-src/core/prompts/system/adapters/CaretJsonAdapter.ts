...
import { API_PROVIDERS, CARET_MODES } from "@careti/shared/constants/PromptSystemConstants"
...
export class CaretJsonAdapter implements IPromptSystem {
	...
	public async getPrompt(context: CaretSystemPromptContext): Promise<string> {
		...
		// CARETI MODIFICATION: Gate Task tool by subagent availability (disabled in Caret mode v0.4.4)
	 ...
	 * CARETI MODIFICATION: Ensure Caret rules are passed into the system prompt.
	 */
