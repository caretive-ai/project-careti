...
func caretSignOut(ctx context.Context) error {
	...
	fmt.Println("You have been signed out of Caret (careti.ai).")
	return nil
}
...
func caretSignIn(ctx context.Context) error {
	...
	fmt.Println("\n  Opening browser for Caret authentication (careti.ai)...")
...
func HandleSelectCaretOrganization(ctx context.Context) error {
	...
	fmt.Println("Visit https://careti.ai/usage to manage organizations.")
	return HandleAuthMenuNoArgs(ctx)
}
