...
<Note>
캐럿(Caret) 기준 문서입니다. Cline v3.38.1 머지본을 따르며, 캐럿 전용 정책/차이(지원 에디터/스토어, UI 레이블)가 있으면 본문에 `<Note>`로 표시합니다.
</Note>

<Note>
브랜딩/UI: `caret-docs/features/f03-branding-ui.md`에 따라 캐럿 브랜딩(아이콘/라벨/배너) 우선 사용. 에디터/스토어 지원 여부도 캐럿 기준으로 안내하세요.
</Note>
