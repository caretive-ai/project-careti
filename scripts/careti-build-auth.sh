...
mkdir -p "${ROOT}/dist-standalone/extension/careti-src/core/prompts/sections"
cp -r "${ROOT}/careti-src/core/prompts/sections/." "${ROOT}/dist-standalone/extension/careti-src/core/prompts/sections/"
