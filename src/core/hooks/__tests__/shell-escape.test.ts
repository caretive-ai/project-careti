...
describe("Shell Path Escaping", () => {
	...
	describe("Windows path escaping", () => {
		...
		it("should handle workspace hooks with spaces in root", () => {
			const path = "C:\\Users\\user\\My Example Project\\.agents\\hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\user\\My Example Project\\.agents\\hooks\\PreToolUse"')
		})
	...
	describe("Multi-root workspace scenarios", () => {
		...
		it("should handle multiple roots with spaces (Windows)", () => {
			setPlatform("win32")
			const roots = [
				"C:\\Users\\user\\My Frontend Project\\.agents\\hooks\\PreToolUse",
				"C:\\Users\\user\\My Backend Project\\.agents\\hooks\\PreToolUse",
				"C:\\Users\\user\\Shared Utils\\.agents\\hooks\\PreToolUse",
			]
