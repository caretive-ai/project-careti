...
const Logger = {
	error: (...args: unknown[]) => console.error("[devstral/config]", ...args),
	warn: (...args: unknown[]) => console.warn("[devstral/config]", ...args),
}
...
export const config = createVariant(ModelFamily.DEVSTRAL)
	...
	.tools(
		...
		ClineDefaultTool.GENERATE_EXPLANATION, // CARETI MODIFICATION: Added for explain-changes feature
	)
	.placeholders({
