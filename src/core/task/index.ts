...
export class Task {
	...
	async *attemptApiRequest(previousApiReqIndex: number): ApiStream {
		...
		const promptContext: SystemPromptContext = {
			...
			localClineRulesFileInstructions: activeRuleInstructions, // CARET MODIFICATION: Use priority system
			localCursorRulesFileInstructions: undefined, // CARET MODIFICATION: handled by priority system
			localCursorRulesDirInstructions: undefined, // CARET MODIFICATION: handled by priority system
			localWindsurfRulesFileInstructions: undefined, // CARET MODIFICATION: handled by priority system
