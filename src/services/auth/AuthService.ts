...
import { AuthState, UserInfo } from "@shared/proto/caret/account"
import { type EmptyRequest, String } from "@shared/proto/caret/common"
...
export class AuthService {
	...
	async createAuthRequest(controller: Controller): Promise<String> {
		if (this._authenticated) {
			this.sendAuthStatusUpdate()
			return String.create({ value: "Already authenticated" })
		}

		// CARET MODIFICATION: Use environment variables and nonce to construct the auth URL, pointing to our backend
