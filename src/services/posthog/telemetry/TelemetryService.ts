...
class TelemetryService {
	...
	/** Dummy PostHog client instance (PostHog disabled in Caret) */
	private client: any // DummyPostHogClient
	 ...
	 * Initializes dummy PostHog client (PostHog disabled in Caret)
	 */
	private constructor() {
		this.client = posthogClientProvider.getClient()
		console.log("[Caret] TelemetryService using dummy PostHog client")
	}
