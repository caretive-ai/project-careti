...
export class TelemetryService {
	...
	private telemetryCategoryEnabled: Map<TelemetryCategory, boolean> = new Map([
		...
		["subagents", true], // Subagents telemetry enabled
	])
	...
	/**
	 * Records when CLI subagent feature is enabled/disabled
	 * @param enabled Whether subagents were enabled (true) or disabled (false)
	 */
	 ...
	 * @param ulid Unique identifier for the task
	 * @param durationMs Duration of subagent execution in milliseconds
	 * @param outputLines Number of output lines produced
