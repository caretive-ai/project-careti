// CARET MODIFICATION: AutoApproveModal wrapper with i18n support
// This component wraps the original AutoApproveModal and adds internationalization
...
interface AutoApproveModalWrapperProps {
	isVisible: boolean
...
const AutoApproveModalWrapper: React.FC<AutoApproveModalWrapperProps> = ({
	isVisible,
	setIsVisible,
	buttonRef,
	ACTION_METADATA,
		...
		<div ref={modalRef}>
			<div
				...
				<div className="flex justify-between items-center mb-3">
					<HeroTooltip content={t("modal.autoApprove.description", "common")} placement="top">
						<div className="text-base font-semibold mb-1">{t("modal.autoApprove.title", "common")}</div>
					</HeroTooltip>
				...
				<div className="mb-2.5">
					<span className="text-[color:var(--vscode-foreground)] font-medium">
						{t("modal.autoApprove.actions", "common")}
					</span>
				</div>
				...
				<div className="mb-2.5">
					<span className="text-[color:var(--vscode-foreground)] font-medium">
						{t("modal.autoApprove.quickSettings", "common")}
					</span>
				</div>
				...
				<HeroTooltip content={t("modal.autoApprove.maxRequestsTooltip", "common")} placement="top">
					<div className="flex items-center pl-1.5 my-2">
						...
						<span className="text-[#CCCCCC] text-xs font-medium ml-2">
							{t("modal.autoApprove.maxRequests", "common")}
						</span>
						<VSCodeTextField
...
export default AutoApproveModalWrapper
