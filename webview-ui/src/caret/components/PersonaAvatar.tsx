...
// CARET MODIFICATION: Convert asset:// URIs to proper image paths
const convertAssetToImagePath = async (assetUri: string): Promise<string> => {
	...
	if (assetUri.startsWith("asset://template_characters/")) {
		...
		try {
			...
			caretWebviewLogger.info("Converted asset URI to Vite path", { assetUri, imageUrl })
			return imageUrl
		} catch (error) {
			caretWebviewLogger.error("Failed to convert asset URI with Vite, trying static path", { assetUri, error })
	...
	caretWebviewLogger.warn("No conversion available for asset URI, using fallback", { assetUri, windowProps })
...
const LOADING_PERSONA_AVATAR =
	"data:image/svg+xml;base64,"
...
export const PersonaAvatar: React.FC<PersonaAvatarProps> = ({
	...
	// Convert asset:// URI to proper path when URI changes
	useEffect(() => {
		if (rawImageUri) {
			convertAssetToImagePath(rawImageUri)
