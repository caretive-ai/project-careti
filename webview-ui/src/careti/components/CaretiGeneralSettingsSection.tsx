// CARETI MODIFICATION: Copy-and-Modify from careti-main - General Settings Section with i18n

// CARETI MODIFICATION: Import feature configuration for conditional rendering
...
// CARETI MODIFICATION: 통합 언어 설정 컴포넌트와 전역 브랜드 모드 토글
import ModeSystemToggle from "./ModeSystemToggle"
import UnifiedLanguageSetting from "./UnifiedLanguageSetting"

interface CaretiGeneralSettingsSectionProps {
	renderSectionHeader: (tabId: string) => JSX.Element | null
}

const CaretiGeneralSettingsSection: React.FC<CaretiGeneralSettingsSectionProps> = ({ renderSectionHeader }) => {
	// CARETI MODIFICATION: Add telemetry setting with i18n, modeSystem, and persona system restored
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<Section>
				{/* CARETI MODIFICATION: 전역 브랜드 모드 토글 - 최상단에 배치 */}
				...
				{/* CARETI MODIFICATION: 통합 언어 설정 - LLM과 UI 언어 자동 동기화 */}
				<div className="mb-6">
					<UnifiedLanguageSetting />
				</div>

				{/* CARETI MODIFICATION: 페르소나 설정 - Careti 모드이고 브랜드 설정에서 허용할 때만 표시 */}
				{/* CARETI MODIFICATION: Only show when explicitly enabled in feature config */}
				{featureConfig?.showPersonaSettings === true && modeSystem === "careti" && (
					<div className="mb-6">
				...
				{/* CARETI MODIFICATION: Telemetry setting with i18n */}
				<div className="mb-[5px]">
					<VSCodeCheckbox
...
export default React.memo(CaretiGeneralSettingsSection)
