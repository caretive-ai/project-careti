// CARETI MODIFICATION: Webview logging system with safety checks
 ...
 * CARETI MODIFICATION: Added safety checks to prevent webview loading failures
 */
class WebviewLogger {
	...
	constructor(component: string) {
		...
		// CARETI MODIFICATION: Use IS_DEV defined by Vite config (string 'true' or 'false')
	...
	private log(level: LogLevel, message: string, data?: any): void {
		...
		// CARETI MODIFICATION: Safe console logging (development only)
		...
		// CARETI MODIFICATION: Safe Extension Host communication
		try {
...
export const caretWebviewLogger = new WebviewLogger("Careti")
