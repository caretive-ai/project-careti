// CARET MODIFICATION: Cline 모듈 구조 채택 + Caret 고유 기능 통합
...
// CARET MODIFICATION: Caret 고유 기능 Hook 추가
import { useCaretFeatures } from "./chat-view/hooks/useCaretFeatures"
...
const ChatView = ({ isHidden, showAnnouncement, hideAnnouncement, showHistoryView }: ChatViewProps) => {
	// CARET MODIFICATION: Caret 고유 기능 통합 (최소 침입)
	const { logger, t } = useCaretFeatures("ChatView")
