...
const ChatView = ({ isHidden, showAnnouncement, hideAnnouncement, showHistoryView }: ChatViewProps) => {
	...
	// CARET MODIFICATION: Debug message updates
	useEffect(() => {
		console.log("[ChatView] Messages updated, total count:", messages.length)
		if (messages.length > 0) {
			console.log("[ChatView] Last message:", messages[messages.length - 1])
		}
	}, [messages])
