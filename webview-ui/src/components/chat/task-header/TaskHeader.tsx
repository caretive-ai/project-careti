					...
					<div className="flex justify-between items-center">
						...
						{isTaskExpanded && (
							<div className="mt-1 flex justify-end cursor-pointer opacity-80 gap-2 mx-2">
								...
								<DeleteTaskButton taskId={currentTaskItem?.id} taskSize={String(currentTaskItem?.size || "")} />
								{/* Only visible in development mode */}
								{IS_DEV && <OpenDiskConversationHistoryButton taskId={currentTaskItem?.id} />}
							</div>
						)}
					</div>
