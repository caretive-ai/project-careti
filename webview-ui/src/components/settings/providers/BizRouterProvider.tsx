			...
			{modelConfigurationSelected && (
				<>
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.temperature !== undefined
									? bizRouterModelInfo.temperature.toString()
									: ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
						...
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.topP !== undefined ? bizRouterModelInfo.topP.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
								const parsed = value === "" ? undefined : parseFloat(value)
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.topK !== undefined ? bizRouterModelInfo.topK.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
						...
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.minP !== undefined ? bizRouterModelInfo.minP.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
								const parsed = value === "" ? undefined : parseFloat(value)
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.frequencyPenalty !== undefined ? bizRouterModelInfo.frequencyPenalty.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
								const parsed = value === "" ? undefined : parseFloat(value)
						...
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.presencePenalty !== undefined ? bizRouterModelInfo.presencePenalty.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
								const parsed = value === "" ? undefined : parseFloat(value)
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<DebouncedTextField
							initialValue={
								bizRouterModelInfo?.repetitionPenalty !== undefined ? bizRouterModelInfo.repetitionPenalty.toString() : ""
							}
							onChange={(value) => {
								const modelInfo = bizRouterModelInfo ? bizRouterModelInfo : { ...bizRouterModelInfoSaneDefaults }
								const parsed = value === "" ? undefined : parseFloat(value)
