...
// CARET MODIFICATION: Add CaretModelInfo
...
message ModelsApiConfiguration {
  ...
  // CARET MODIFICATION: Caret-specific fields
  optional string caret_base_url = 1000;
  optional string caret_api_key = 1001;
  optional bool caret_use_prompt_cache = 1002;
  optional string plan_mode_caret_model_id = 1190;
  optional CaretModelInfo plan_mode_caret_model_info = 1191;
  optional string act_mode_caret_model_id = 1290;
  optional CaretModelInfo act_mode_caret_model_info = 1291;
}
